    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='Titre du livre', max_length=200, verbose_name='Titre')),
                ('author', models.CharField(help_text="Nom de l'auteur", max_length=150, verbose_name='Auteur')),
                ('year', models.PositiveIntegerField(help_text='Année de publication du livre', verbose_name='Année de publication')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='Adresse email du lecteur (doit être unique)', max_length=254, unique=True, validators=[django.core.validators.EmailValidator()], verbose_name='Email')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, help_text='Notes supplémentaires sur la réservation', verbose_name='Notes')),
